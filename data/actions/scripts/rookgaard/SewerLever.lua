local config = {
    bridgePositions = {
        {position = Position(32099, 32205, 8), groundId = 351, itemId = 0},
        {position = Position(32100, 32205, 8), groundId = 508, itemId = 0},
        {position = Position(32101, 32205, 8), groundId = 509, itemId = 0}
    },
    leverPositions = {
